<template>
  <div class="flex flex-col bg-white">
    <ExternalLink href="https://devlounge.it">
      <img src="https://devlounge.it/images/logo.svg" alt="" class="w-15 h-15 mt-3 p-6">
    </ExternalLink>
        ...
        <ul class="flex flex-col w-full">
          <li class="my-px">
            <router-link to="/">
              <a href="#"
                 ...
                 :class="currentRoute === 'home' ? 'bg-gray-100': 'hover:bg-gray-100'"
              >
          ...
          <li class="my-px">
            <router-link to="/services">
              <a href="#"
                 class="flex flex-row items-center h-12 px-4 rounded-lg text-gray-600"
                 :class="currentRoute === 'services' ? 'bg-gray-100': 'hover:bg-gray-100'"
              >
                <span class="flex items-center justify-center text-lg text-gray-400">
                  <svg fill="none"
                       stroke-linecap="round"
          ...
          <li class="my-px">
            <router-link to="/sites">
              <a href="#"
                 class="flex flex-row items-center h-12 px-4 rounded-lg text-gray-600"
                 :class="currentRoute === 'sites' ? 'bg-gray-100': 'hover:bg-gray-100'"
              >
              <span class="flex items-center justify-center text-lg text-gray-400">
                <svg fill="none"
                     stroke-linecap="round"
          ...
          <li class="my-px">
            <span class="flex font-medium text-sm text-gray-400 px-4 my-4 uppercase">Settings</span>
          </li>
          <li class="my-px">
            <a href="#"
               class="flex flex-row items-center h-12 px-4 rounded-lg text-gray-600 hover:bg-gray-100">
